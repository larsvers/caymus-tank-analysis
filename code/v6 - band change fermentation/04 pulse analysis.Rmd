...
df_focus <- df_pulse %>% 
  ...
  mutate(year = year(time), dataset = ifelse(year == 2021, "21", "22"))
...
- Disregarding the unusually short 21-Nov-02 fermentation it seems 22 fermentations need a little less fermentation
...
There's no significant difference between the two means.
