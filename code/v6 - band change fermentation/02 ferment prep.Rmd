...
For each fermentation period calculate the LOESS smoothed brix curve, the smooth brix curve's slope (1st derivative) and the smoth brix curve's accelration (2nd derivative). 

We'll use the slope and accelration to detect points 2 (curve start), just the slope to detect point 3 (curve inflection) and 4 (curve end).
...
Point 4 condition - curve inflection, brix slope increaes: brix must be below 0
...
Condition: find the minimum after slope (1st derivative) for each fermentation period.
