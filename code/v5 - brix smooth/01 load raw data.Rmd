---
title: "Data v5 analysis - load"
output: html_notebook
---

This analysis looks at isolating the Fermentation periods

This notebook follows the `01 load raw data.Rmd` file from v4...
...
(df_orig <- df_orig %>% 
  select(time = 1, brix = 5, temp = 7, status = 11, setpoint = 9, abv = 4, gravity = 6))
...
write_csv(df, paste0(root_path, '/data/v5/df-clean-c1.csv', na = ""))
